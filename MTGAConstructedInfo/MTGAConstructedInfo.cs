...
namespace MTGAContructedInfo
{
    class MTGAConstructedInfo
    {
        static void Main(string[] args)
        {
            ...
            var appPath = userFolder + "/MTGAContructedInfo/";
            ...
            while(true)
            {
                try
                {
                    using (var fileStream = File.Open(userFolder + "/Wizards Of The Coast/MTGA/output_log.txt", FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite))
                    {
                        ...
                        using (FileStream fs = File.Create(appPath + "MTGAConstructedRankInfo.txt"))
                        {
                            string rank;
